...
export default function Signup() {
  const [step, setStep]                 = useState(1) // 1=form, 2=verify email notice
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-primary-100 text-primary-700 text-xs font-semibold px-3 py-1.5 rounded-full w-fit mb-4 md:mb-6">
            <Zap size={13} /> Free forever — no credit card needed
          </div>
          ...
          <h2 className="text-2xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-3 md:mb-4">
            Run your freelance{' '}<span className="text-primary-600">business smarter.</span>
          </h2>
          ...
          <ul className="grid grid-cols-2 md:grid-cols-1 gap-2 md:gap-3 mb-5 md:mb-10">
            {perks.map(({ icon: Icon, text }) => (
              <li key={text} className="flex items-center gap-2 text-xs md:text-sm text-gray-700">
                <Icon size={14} className="text-primary-600 shrink-0" />{text}
              </li>
            ))}
          </ul>
            ...
            <AnimatePresence mode="wait">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input type="text" value={name} onChange={e => setName(e.target.value)}
                          className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 text-gray-900 transition-all"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)}
                          className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 text-gray-900 transition-all"
              ...
              {step === 2 && (
                <motion.div key="verify"
                  ...
                  <Link to="/login" className="btn-primary py-3 px-8 inline-block">
                    Go to Login
                  </Link>
                </motion.div>
              )}
